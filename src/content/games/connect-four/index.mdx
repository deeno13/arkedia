...
Below, columns are numbered 1 to 7 from the left (the same numbers you can press on the keyboard), rows 1 to 6 from the bottom, **X** is the first player and **O** the second.
